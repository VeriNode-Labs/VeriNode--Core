...
use sorosusu_contracts::attestation::verifier::{
    sign_attestation, verify_attestation_with_committee_view, AttestationData, SecretKey, Signature,
};
...
fn test_stable_committee_verification() {
    ...
    assert!(
        result,
        "Attestation verification should succeed with stable committee"
    );
}
